# Draft SoftwareX metadata

> Replace all bracketed placeholders only after the public repository, archived
> release, software DOI, authorship, and real-pilot evidence are verified. The
> bundled demonstration is synthetic and must not be submitted as empirical evidence.
...
- Complete normalized Gate 0–7 synthetic demonstration.
- Local browser dashboard for governance, pilot, real-pilot, and release readiness.
- Versioned consent-document metadata and SHA-256 verification.
- Participant CSV import that refuses direct identifiers and stores only hashed source tokens.
- Enrollment, eligibility, withdrawal, and data-use-scope records.
- Automated missingness, consent, task-coverage, crossover, installation, and withdrawal checks.
